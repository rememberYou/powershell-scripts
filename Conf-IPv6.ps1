...
.EXAMPLE
    PS C:\> Conf-IPv5 -Name SRVDNSPrimary -InterfaceIndex 5 -IP ACAD::10 -Length 64 -Gateway FE80::1 -DnsSec ACAD::11

.EXAMPLE
    PS C:\> Conf-IPv6 -InterfaceIndex 5 -IP ACAD::10 -Length 64 -Gateway FE80::1 -DnsSec ACAD::11
